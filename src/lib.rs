...
#[derive(Debug)]
pub struct GitbookDocsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GitbookDocsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GitbookDocs processing");
    
    let mut processor = GitbookDocsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GitbookDocsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GitbookDocsProcessor::new(false);
